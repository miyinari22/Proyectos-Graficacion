...
void pinta(void){
	...
	glVertex2i(-200,-150); glVertex2i(-200,-70);
	glVertex2i(50,-150); glVertex2i(50,-70);
	glVertex2i(-250,-110); glVertex2i(-150, -110);
	glVertex2f(10,-110); glVertex2i(100,-110);
	glEnd();
	
	////Puerta//
	glBegin(GL_POLYGON);
	glColor3f(71.0/255.0,14.0/255.0,3.0/255.0);
	glVertex2i(-350,-200); glVertex2i(-280,-200); glVertex2i(-280,-70); glVertex2i(-350,-70);
	glEnd();
	
	glBegin(GL_LINE_STRIP);
	glColor3f(40.0/255.0,7.0/255.0,2.0/255.0);
	glVertex2i(-340,-190); glVertex2i(-290,-190); glVertex2i(-290,-80); glVertex2i(-340,-80); glVertex2i(-340,-190);
	glEnd();
	
	float r=5, x2, y2; //Picaporte///
	glBegin(GL_POLYGON);
	glColor3f(228.0/255.0,190.0/255.0,35.0/255.0);
	for (i=0;i<10; i+=0.01){
		x2= r * cos(i);
	...
	glVertex2i(-245,-150); glVertex2i(-265,-160); glVertex2i(-245,-160);
	glEnd();
	...
	for (i=0;i<10; i+=0.01){
		calx2= r2 * cos(i);
		caly2= r2 * sin(i);
		glVertex2f(calx2+-260,caly2-200);
	}
	glEnd();
	...
	glVertex2i(-254,-160); glVertex2i(-240,-200);
	glVertex2i(-224,-160); glVertex2i(-210,-200);
	glColor3f(128.0/255.0,255.0/255.0,0.0);
	glVertex2i(-228,-160); glVertex2i(-217,-160);
	glEnd();
	
	glBegin(GL_LINE_STRIP); //Estructura de la bicicleta
	glColor3f(255.0/255.0,128.0/255.0,0.0);
	glVertex2i(-250,-170); glVertex2i(-220,-170); glVertex2i(-230,-200); glVertex2i(-260,-200); glVertex2i(-250,-170);
	glEnd();
